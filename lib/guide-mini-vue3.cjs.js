...
function proxyRefs(objectwithRefs) {
    if (objectwithRefs === void 0) { objectwithRefs = {}; }
...
function createRender(options) {
    var createTextNode = options.createTextNode, insert = options.insert, createElement = options.createElement, hostPatchProps = options.hostPatchProps, setElementInnerContext = options.setElementInnerContext, removeAllChildren = options.removeAllChildren;
    ...
    function patchChildren(n1, n2, container) {
        // n1 children 是文本节点
        if (!!(n1.shapeFlag & 4 /* ShapeFlags.TEXT_CHILDREN */)) {
