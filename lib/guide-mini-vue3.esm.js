...
function createRender(options) {
    var createTextNode = options.createTextNode, insert = options.insert, createElement = options.createElement, patchProps = options.patchProps;
    ...
    function processText(vnode, container) {
        ...
        var textNode = (vnode.el = createTextNode(children));
